package com.server.MBHBackend.Security.config;
...
import static com.server.MBHBackend.Security.user.Role.ADMIN;
import static com.server.MBHBackend.Security.user.Role.MANAGER;
